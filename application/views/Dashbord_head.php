                                              ...
                                              <div class="row">
                                                  <div class="col-md-12 pt-4">
                                                    <?php if ($this->session->flashdata('enquiry_success')) { ?>
                                                        <p class="bg-success text-center"><?php echo $this->session->flashdata('enquiry_success'); ?></p>
                                                    <?php } ?>
                                                    <?php if ($this->session->flashdata('enquiry_faile')) { ?>
                                                        <p class="bg-danger text-center"><?php echo $this->session->flashdata('enquiry_faile'); ?></p>
                                                    <?php } ?>
                                                  </div>
